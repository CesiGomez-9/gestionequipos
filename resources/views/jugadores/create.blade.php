<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-3xl text-white leading-tight">
            Añadir Jugador a {{ $equipo->nombre }}
        </h2>
    </x-slot>

    <div class="py-12 max-w-xl mx-auto sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('jugadores.store', $equipo) }}" class="bg-white dark:bg-gray-800 p-6 rounded shadow">
            @csrf

            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-300">Nombre</label>
                <input type="text" name="nombre" value="{{ old('nombre') }}" class="w-full mt-1 rounded border-gray-300 dark:bg-gray-700 dark:text-white" required>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="edad" value="{{ old('edad') }}" class="w-full mt-1 rounded border-gray-300 dark:bg-gray-700 dark:text-white" required>
